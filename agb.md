...
(6)  Patente, Marken-, Urheber-, Lizenz- oder sonstige Schutzrechte Dritter sind zu beachten. Der Kunde stellt AVENTER von allen Ansprüchen aus der Benutzung von Schutzrechten Dritter oder wegen eines Verstoßes dagegen frei.
...
Die Sofware wird verkauft wie sie aktuell ist. Mit der Benutzung der Software bestätigen Sie, dass das Benutzen der Software IHR EIGENES RISIKO ist. Jeder durch die Software verursachter Schaden geht ebenfalls auf Ihr Risiko. AVENTER stellt nicht sicher das die Software weiter entwickelt, fehlerfrei, ununterbrochen, verlässlich oder sicher läuft.

## §12 Eigentumsverhältnis

Die von AVENTER für den Kunden entwickelte Software, WebEntwicklungen und das Design von Webseiten, bleibt Eigentum von AVENTER und geht auch nach Kündigung des Vertrages, beendigung des Projektes oder Fertigstellung nicht in den Besitz des Kunden über. Dies gilt nicht für die vom Kunden gelieferten Inhalte der WebSeite oder Software.

## §13 Sozial- und Umweltbewusstsein

Der Kunde von AVENTER individuellen IT Services verpflichtet sich, seine Firma, welche von AVENTER unterstützt wird, Sozial und nach Umweltschutzrichtlinien der EU zu führen. Sollten AVENTER Informationen vorliegen, nach der Soziale oder Umwelttechnische Missstände bei dem Kunden herrschen, kann AVENTER die Verträge einseitig Kündigen.

## §14 Kündigung 

Wurde zwischen Kunde und AVENTER nichts weiteres vereinbart, kann der Kunde sein Produkt zum Monatsende Schriftlich, über EMail an den Support oder über das Kundencenter kündigen. Eine Kündigung wird sofort ohne Karentszeit und ohne Nachfrage durchgeführt. Eine Beitrags Rückerstatung ist nciht möglich.
